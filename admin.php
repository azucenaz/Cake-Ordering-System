<ul id="nav">
        ...
        <li <?php if($_SESSION['current'] == 'products'){ echo 'class="current"';}?>> <a href="products.php"> <i class="fa fa-dropbox"></i> Products </a> </li>
        ...
        <li <?php if($_SESSION['current'] == 'users'){ echo 'class="current"';}?>> <a href="users.php"> <i class="icon-user"></i> Users </a> </li>
