        ...
        <div class="col-lg-12">
          <div class="widget">
            <div class="widget-header">
              &nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" data-toggle="modal" data-target="#addcustomers">Add Products</button>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 id="myModalLabel" class="modal-title">Add products</h4>
                      </div>
                      <div class="modal-body">
                        <form method="post" action="query/addproducts.php" class="form-horizontal">
                         Product Category 
                         ...
                         Product Name <input type="text" class="form-control" name="productname" required>
                         Product Price <input type="number" step="0.01" min="0" class="form-control" name="productprice" required>
...
<div class="example_alt_pagination">
  ...
  <div id="demo">
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
      ...
      <tbody>
        <?php
        $getcustomers = $dbConn->query("SELECT * FROM tbl_products");
               ...
               <div style="display: none;" aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal fade" id="edit<?php echo $row['id'];?>">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="post" action="query/editproducts.php" class="form-horizontal">
                        <input type="hidden" value="<?php echo $row['id'];?>" name="id">
                        Product Category 
                        <select class="form-control" name="product_category">
                          <option value="">Choose</option>  
                          <option value="Cake" <?php  if($row['category'] == 'Cake'){echo "selected";}?>>Cake</option>
                          <option value="Cake Type" <?php  if($row['category'] == 'Cake Type'){echo "selected";}?>>Cake Type</option>
                          <option value="Design" <?php  if($row['category'] == 'Design'){echo "selected";}?>>Design</option>
                         </select>
                         Product Name <input type="text" class="form-control" name="productname" required value="<?php print $row['product_name'];?>">
                         Product Price <input type="number" step="0.01" min="0" class="form-control" name="productprice" required value="<?php print $row['price'];?>">
                         Description <textarea class="form-control" name="description" required><?php print $row['description'];?></textarea> 
